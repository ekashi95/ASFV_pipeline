...
Установите Docker Desktop по инструкции с официального сайта (https://docs.docker.com/desktop/setup/install/linux/ubuntu/) и запустите его. (Вместо Docker Desktop можно установить и Docker Engine, тогда он запустится из командной строки.)

Загрузите образ Docker-контейнера: 
```
...
Зайдите в папку с файлами пайплайна и запустите скрипт ``1.sh``:
```
chmod 777 1.sh
./1.sh
```
